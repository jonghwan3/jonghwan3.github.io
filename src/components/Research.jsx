    ...
    <div id="research" className="mobile-container">
        ...
        <div className="mobiles-box">
            <div className="mobile-box">
                ...
                <h4>
                LLMs, Distributed learning, Computation-efficient methods (Pruning, Quantization), Huggingface
                </h4>
        ...
        <div className="mobiles-box">
            <div className="mobile-box">
                <img src="research2_1.png" className="research-img"></img>
                <img src="research2_2.png" className="research-img"></img>
                ...
                <br></br>
                <br></br>
                🔹 Achieved a staggering 99.4% reduction in communication overhead—without compromising accuracy!
                </h3>
                <h4>
                LLMs, Distributed learning, Computation-efficient methods (Pruning, Quantization), Huggingface
                </h4>
